...
(async function () {
    ...
    const applicationName = 'DS1522p' //Defualt is Emby but
    if (document.querySelector('meta[name="application-name"]').content == applicationName) {
	...
	const mediaQueryStr = 'video';
        ...
        async function createDanmaku(comments) {
            ...
            _container.lastChild.style.opacity = 0.5;
